...
/**
 * RoleCtl Controller is used to handle Role operations
 * like Add, Update, View and Validation.
 *
 * It interacts with RoleModel to perform CRUD operations
 * and forwards to Role view JSP.
 *
 * @author Deepak Verma
 * @version 1.0
 */
