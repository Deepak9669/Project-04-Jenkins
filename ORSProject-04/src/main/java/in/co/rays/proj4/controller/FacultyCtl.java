...
/**
 * FacultyCtl Controller handles all Faculty related operations
 * like Add, Update, View and Validation.
 * 
 * It also preloads College, Course and Subject data for dropdowns.
 * 
 * @author Deepak Verma
 * @version 1.0
 */
...
public class FacultyCtl extends BaseCtl {
    ...
    /**
     * Preloads data like College List, Course List and Subject List
     * before loading Faculty page.
     * 
    ...
    /**
     * Populates FacultyBean using request parameters.
     * 
     * @param request HTTP request object
    ...
    /**
     * Handles GET request for loading Faculty form.
     * 
     * @param request  HTTP request
    ...
    /**
     * Returns Faculty view page path.
     * 
     * @return Faculty View JSP path
     */
    @Override
