...
/**
 * StudentCtl Controller handles operations related to Student,
 * such as Add, Update, View and Validation.
 *
 * It also preloads college list for the Student form.
 *
 * @author Deepak Verma
 * @version 1.0
 */
...
public class StudentCtl extends BaseCtl {
    ...
    /**
     * Preloads list of colleges for the Student form dropdown.
     *
    ...
    /**
     * Validates Student form input fields.
     *
     * @param request HTTP request
    ...
    /**
     * Handles GET request to display Student form for Add/Update.
     *
     * @param request  HTTP request
    ...
    /**
     * Returns Student view page path.
     *
