...
/**
 * Model class for Timetable entity. Provides methods for CRUD operations
 * and various validation checks for timetable entries.
 *
 * @author Deepak Verma
 * @version 1.0
 */
public class TimetableModel {
    ...
    /**
     * Gets the next primary key for the st_timetable table.
     *
     ...
     * @throws DuplicateRecordException if a duplicate record is found (if you later add checks)
     */
     ...
     *
     * @param bean TimetableBean containing updated timetable details
     * @throws ApplicationException     if any application level error occurs
     * @throws DuplicateRecordException if a duplicate record is found (if you later add checks)
     */
     ...
     *
     * @param bean TimetableBean containing ID of timetable to delete
     * @throws ApplicationException if any application level error occurs
     */
     ...
     *
     * @param pk primary key of timetable
     ...
     * @return matching TimetableBean if found, otherwise null
     * @throws ApplicationException if any application level error occurs
     */
    ...
    /**
     * Checks timetable by exam time, description and other details.
     *
     * @param courseId    course ID
     * @param subjectId   subject ID
     * @param semester    semester
    ...
    /**
     * Searches timetable records based on given criteria.
     *
     * @param bean     search criteria bean (can be null)
     * @param pageNo   page number (for pagination)
     * @param pageSize number of records per page
     * @return list of TimetableBean matching the criteria
     * @throws ApplicationException if any application level error occurs
     */
